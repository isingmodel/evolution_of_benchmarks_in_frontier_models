...
- The headline pattern is easy to explain: in `provider_hypothesis_period_summary.csv`, Google's 2024 broad long-context share is 39.3%, versus OpenAI 2.4% and Anthropic 5.8%.
- The stricter primary-only metric still supports the 2024 case under the current taxonomy: Google is 35.7%, Anthropic is 2.1%, and OpenAI is 2.4%.
...
| --- | ---: | ---: | --- | ---: |
| OpenAI | 2.4% | 2.4% | `EgoSchema` on GPT-4o | 3 |
| Google | 39.3% | 35.7% | `Needle In A Haystack` on Gemini 1.5 | 2 |
| Anthropic | 5.8% | 2.1% | `SWE-bench verified` on Claude 3.5 Haiku | 3 |
...
- Include raw mention shares beside release-normalized shares in an appendix, since the contrast between Google's 39.3% normalized share and 31.3% raw share matters for interpretation.
