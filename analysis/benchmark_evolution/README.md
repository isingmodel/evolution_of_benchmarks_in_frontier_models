...
```bash
.venv/bin/python analysis/benchmark_evolution/analyze.py --as-of 2026-08-13 --strict-resolution
.venv/bin/python analysis/benchmark_evolution/benchmark_count_trend.py --as-of 2026-08-13 --window-days 90 --strict-resolution
```
