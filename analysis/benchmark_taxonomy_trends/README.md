...
```bash
.venv/bin/python analysis/benchmark_taxonomy_trends/task_mode_trend.py --as-of 2026-07-24 --window-days 180 --strict-resolution
.venv/bin/python analysis/benchmark_taxonomy_trends/separate_axis_trends.py --as-of 2026-07-24 --window-days 180 --review-debt-output assets/benchmark_review_debt.png --strict-resolution
.venv/bin/python analysis/benchmark_taxonomy_trends/facet_trends.py --as-of 2026-07-24 --window-days 180 --top-labels 8 --strict-resolution
```
