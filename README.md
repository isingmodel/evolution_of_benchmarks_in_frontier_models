...
Example source pages from the latest rows:

| Provider   | Model name            | release date   | link                                                                                           |
|:-----------|:----------------------|:---------------|:-----------------------------------------------------------------------------------------------|
| OpenAI     | GPT-5.5               | 2026-04-23     | https://openai.com/index/introducing-gpt-5-5/                                                  |
| Anthropic  | Claude 4.7 (Opus)     | 2026-04-16     | https://www.anthropic.com/news/claude-opus-4-7                                                 |
| OpenAI     | GPT-5.4               | 2026-03-05     | https://openai.com/index/introducing-gpt-5-4/                                                  |
| Google     | Gemini 3.1 Flash-Lite | 2026-03-03     | https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-3-1-flash-lite/ |
| Google     | Gemini 3.1 Pro        | 2026-02-19     | https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-3-1-pro/        |
| OpenAI     | GPT-5.3-Codex         | 2026-02-05     | https://openai.com/ko-KR/index/introducing-gpt-5-3-codex/                                      |
...
## Lightweight Sensitivity Snapshot
These checks are simple proxies from the current normalized tables, not a substitute for a full benchmark-family audit. They show why composite indices and version families should be analyzed separately before making strong provider-level claims.

Composite/index sensitivity:

| scenario                              |   mentions |   Agentic |   Generative Reasoning |   Other task modes |
|:--------------------------------------|-----------:|----------:|-----------------------:|-------------------:|
| All latest-window mentions            |        200 |        87 |                     79 |                 34 |
| Exclude explicit composite/index rows |        198 |        87 |                     77 |                 34 |

Version-family proxy counts:

| benchmark_family_proxy   |   latest_window_mentions |
|:-------------------------|-------------------------:|
| SWE-bench / SWE-Lancer   |                       20 |
| Terminal-Bench           |                       10 |
| ARC-AGI                  |                        9 |
| MRCR                     |                        7 |
| OSWorld                  |                        6 |
